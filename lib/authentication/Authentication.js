...
var Authentication = /** @class */ (function () {
    function Authentication() {
        ...
        aws_amplify_1.default.configure({
            storage: CustomStorage_1.default,
            Auth: {
                region: region,
    ...
    Authentication.prototype.reconfigure = function (config) {
        return aws_amplify_1.default.configure(config);
    };
    /**
    ...
    Authentication.prototype.login = function (username, password) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, aws_amplify_1.Auth.signIn(username.toLowerCase(), password)];
            });
        });
    };
    /**
    ...
    Authentication.prototype.logout = function (global) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, aws_amplify_1.Auth.signOut({
                        global: global,
                    })];
            });
        });
    ...
    Authentication.prototype.loginWithTokens = function (authenticationData) {
        var stage = EnvironmentManagement_1.default.getStage();
        if (stage === EnvironmentManagement_1.StageTypes.LOCAL) {
            stage = EnvironmentManagement_1.StageTypes.DEVELOPMENT;
        }
        var clientId = aws_amplify_1.Auth.configure(null).userPoolWebClientId || stageSettings[stage].clientId;
    ...
    Authentication.prototype.register = function (username, password, email) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, aws_amplify_1.Auth.signUp({
    ...
    Authentication.prototype.confirmRegistration = function (code, username) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, aws_amplify_1.Auth.confirmSignUp(username.toLowerCase(), code, {
    ...
    Authentication.prototype.resendConfirmationCode = function (username) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, aws_amplify_1.Auth.resendSignUp(username.toLowerCase())];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        code = '000000';
                        return [4 /*yield*/, aws_amplify_1.Auth.confirmSignUp(username.toLowerCase(), code, {
    ...
    Authentication.prototype.forgotPassword = function (username) {
        return aws_amplify_1.Auth.forgotPassword(username.toLowerCase());
    };
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        currentUser = _a.sent();
                        if (currentUser) {
                            return [2 /*return*/, aws_amplify_1.Auth.changePassword(currentUser, oldPassword, newPassword)];
                        }
                        return [2 /*return*/];
                }
            });
    ...
    Authentication.prototype.confirmPassword = function (code, username, newPassword) {
        return aws_amplify_1.Auth.forgotPasswordSubmit(username.toLowerCase(), code, newPassword);
    };
    /**
    ...
    Authentication.prototype.getCurrentUser = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, aws_amplify_1.Auth.currentAuthenticatedUser()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    Object.defineProperty(Authentication.prototype, "stage", {
        get: function () {
            var stage = EnvironmentManagement_1.default.getStage() === EnvironmentManagement_1.StageTypes.LOCAL ? EnvironmentManagement_1.StageTypes.DEVELOPMENT : EnvironmentManagement_1.default.getStage();
            if (!stage) {
                stage = EnvironmentManagement_1.StageTypes.DEVELOPMENT;
            }
            return stage;
