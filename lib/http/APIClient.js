...
var Interceptor_1 = require("../util/Interceptor");
var apollo_client_1 = require("apollo-client");
var apollo_cache_inmemory_1 = require("apollo-cache-inmemory");
var apollo_link_http_1 = require("apollo-link-http");
var apollo_link_context_1 = require("apollo-link-context");
var fragmentTypes_1 = require("../schemas/fragmentTypes");
var APIClient = /** @class */ (function () {
    function APIClient(service) {
        var _this = this;
        this._serviceName = service.name;
        var fragmentMatcher = new apollo_cache_inmemory_1.IntrospectionFragmentMatcher({ introspectionQueryResultData: fragmentTypes_1.default });
        var httpLink = new apollo_link_http_1.HttpLink({
            uri: EnvironmentManagement_1.default.getBaseUrl(isNode) + "/gql"
        });
        ...
        var cache = new apollo_cache_inmemory_1.InMemoryCache({ fragmentMatcher: fragmentMatcher });
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = {};
                        return [4 /*yield*/, Authentication_1.default.getCurrentSession()];
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        apiUrl = EnvironmentManagement_1.default.getBaseUrl(isNode) + "/" + this._serviceName + path;
                        if (queryParams) {
                            queryString = qs_1.stringify(queryParams, { addQueryPrefix: true });
                    ...
                    case 3:
                        ...
                        for (_i = 0, _b = Interceptor_1.default.interceptors; _i < _b.length; _i++) {
                            interceptor = _b[_i];
                            if (interceptor.type === 'request') {
                                axios_1.default.interceptors.request.use(interceptor.method);
                            }
                            else if (interceptor.type === 'response') {
                                axios_1.default.interceptors.response.use(interceptor.method);
                            }
                        }
                        // fire the request
